...
<template>
  ...
  <div class="my-10" v-if="status === 'loaded'">
    ...
    <div class="flex items-center">
      ...
      <div class="pl-5">
        <div v-for="n in 5" class="text-xs flex items-center">
          ...
          <input class="ml-2 mr-2" type="range" max="100" :value="
            groupedReviews[n]
    ...
    <button v-if="loggedIn" class="underline my-5" @click="handleShowFormToggle()">
      Write a Review
    </button>
    ...
    <div v-if="showReviews">
      <ProductReviewsCard v-for="review in reviews" :key="review.uid" :review="review" />
    </div>

    <ProductReviewsCardForm v-if="showReviewForm" @submitReview="handleReviewSubmit" :loading="formSubmitting" />
  </div>
</template>